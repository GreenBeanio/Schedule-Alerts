...
def Open_Statistics():
    pass  # will open a panel that has elapsed time and such


def Open_Options():
    pass  # will open a panel with options to turn off colors and sounds


def Open_Schedule():
    pass  # will open a panel that shows information about the schedule, and possibly the ability to skip steps in a different implementaiton
...
### Button Events ###
# Toggling Pomodoro
Stop_Button.clicked.connect(Stop_Schedule)
